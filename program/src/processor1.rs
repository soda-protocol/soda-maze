...
use crate::{verifier::{fsm::*, mock::{prepare_inputs::PrepareInputs, miller_loop::{MillerLoop, MillerLoopFinalize}, final_exponent::{FinalExponentEasyPart, FinalExponentHardPart1, FinalExponentHardPart2, FinalExponentHardPart3}}, ProofA, ProofB, ProofC}, params::{HEIGHT, bn::{Fr, G1Projective254}}, context::Context};
...
pub fn process_instruction(
    ...
    let mut r_inv = FQK254_VALUE.clone();
    r_inv.conjugate();
    let stage = Box::new(FinalExponentHardPart3 {
        index: input[0],
